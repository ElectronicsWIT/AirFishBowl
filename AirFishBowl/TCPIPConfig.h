 ...
 */
#define MY_DEFAULT_HOST_NAME			"FISH1"

#define MY_DEFAULT_MAC_BYTE1            (0xB8)	// Use the default of
#define MY_DEFAULT_MAC_BYTE2            (0x27)	// 00-04-A3-00-00-00 if using
#define MY_DEFAULT_MAC_BYTE3            (0xEB)	// an ENCX24J600 or MRF24WB0M
#define MY_DEFAULT_MAC_BYTE4            (0xA1)	// and wish to use the internal
#define MY_DEFAULT_MAC_BYTE5            (0x61)	// factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x43)	// address instead.

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (10ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (4ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(7706ul)
